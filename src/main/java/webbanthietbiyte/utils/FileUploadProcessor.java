package webbanthietbiyte.utils;
...
public class FileUploadProcessor {
	...
	public static final String URL_IMAGE = "C:/Users/Trong/eclipse-workspace/WebBanThietBiYTe/src/main/webapp/resources/image/thietbi";

	public String saveFile(MultipartFile multipartFile) {

		String fileName = RandomStringUtils.randomAlphanumeric(6)
				+ HamDungChung.toSlug(multipartFile.getOriginalFilename()) + ".jpg";
