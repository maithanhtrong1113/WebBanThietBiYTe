...
<body>
						...
						<div class="card">
							...
							<div class="card-header">
								...
								<div class="form-group row"  >
									...
									<label for="tenNhomThietBi" class="col-sm-1 col-form-label">Tên
										Nhóm Thiết Bị</label>
									<div class="col-sm-3">
									    
									    <!-- Tìm kiếm -->
										<input type="text" class="form-control" id="timKiemTenNhomThietBi"
							...
							<div id="tableData" class="card-body">
								<table class="table table-bordered table-hover">
									...
									<tbody id="tableBody">
										...
										<c:forEach items="${nhomThietBis}" var="x" varStatus="loop">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-header">
					<h4 class="modal-title">Chi tiết nhóm thiết bị</h4>
					<button type="button" class="close" data-dismiss="modal">&times;</button>
				</div>
				<!-- Modal body -->
				<div class="modal-body">
					<div class="row">
						<div class="col-4">Mã nhóm thiết bị</div>

						<div class="col-8 id"></div>
					</div>

					<div class="row">
						<div class="col-4">Tên nhóm thiết bị</div>

						<div class="col-8 tenNhomThietBi"></div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<input
							type="text" class="form-control" id="tenNhomThietBiThem"
							placeholder="Nhập tên Nhóm Thiết Bị"
						>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<input
							type="text" class="form-control" id="tenNhomThietBi"
							placeholder="Nhập tên nhóm Thiết Bị"
						>
	...
	<script type="text/javascript" src="${styleUrl}js/nhomthietbi/trangNhomThietBi.js" ></script>
