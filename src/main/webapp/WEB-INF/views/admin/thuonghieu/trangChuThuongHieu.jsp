...
<body>
						...
						<div class="card">
							...
							<div class="card-header">
								...
								<div class="form-group row"  >
									...
									<label for="tenThuongHieu" class="col-sm-1 col-form-label">Tên
										Thương Hiệu</label>
									<div class="col-sm-3">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<input
							...
							placeholder="Nhập tên nhóm thương hiệu"
						>
	...
	<script type="text/javascript" src="${styleUrl}js/thuonghieu/trangThuongHieu.js" ></script>
