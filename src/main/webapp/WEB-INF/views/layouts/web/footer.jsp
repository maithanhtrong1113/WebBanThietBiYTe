			...
			<div class="row mt-3">
				...
				<div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
					<h6 class="text-uppercase fw-bold mb-4">
						<i class="fas fa-gem me-3"></i> Thanh Trọng Company
					</h6>
					<p>Thanh Trọng Company luôn luôn nổ lực hết mình để mang lại
				...
				<div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
					...
					<p>
						<i class="fas fa-envelope me-3"></i> maithanhtrong@gmail.com
					</p>
					<p>
						<i class="fas fa-phone me-3"></i> 0923782382
					</p>
				</div>
